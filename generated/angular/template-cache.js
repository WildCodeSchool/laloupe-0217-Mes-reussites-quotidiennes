angular.module("app").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("user/home.html",
    ...
    "            <img ng-class=\"{'selected': (color === 1)}\" ng-click=\"changeColor(1)\" class=\"smiley\" src=\"img/smileys/grinning.png\" alt=\"grinning\">\n" +
    "            <img ng-class=\"{'selected': (color === 2)}\" ng-click=\"changeColor(2)\" class=\"smiley\" src=\"img/smileys/confused.png\" alt=\"confused\">\n" +
    "            <img ng-class=\"{'selected': (color === 3)}\" ng-click=\"changeColor(3)\" class=\"smiley\" src=\"img/smileys/angryface.png\" alt=\"crying\">\n" +
    "            <img ng-class=\"{'selected': (color === 4)}\" ng-click=\"changeColor(4)\" class=\"smiley\" src=\"img/smileys/heart.png\" alt=\"pouting\">\n" +
    "            <img ng-class=\"{'selected': (color === 5)}\" ng-click=\"changeColor(5)\" class=\"smiley\" src=\"img/smileys/wink.png\" alt=\"sleeping\">\n" +
    "            <img ng-class=\"{'selected': (color === 6)}\" ng-click=\"changeColor(6)\" class=\"smiley\" src=\"img/smileys/cool.png\" alt=\"cool\">\n" +
    "          </div>\n" +
    "        </md-card-content>\n" +
    "      </md-card>\n" +
    "</div>\n" +
  ...
  $templateCache.put("user/navbar.html",
    ...
    "  </md-content>\n" +
    "\n" +
    "<!-- <<<<<<< 086331a596e20316999dfdc65879af7f746f7a1e\n" +
    "=======\n" +
    "    <md-content class=\"navbar\">\n" +
    "        <md-nav-bar class=\"menu\" md-selected-nav-item=\"currentNavItem\" nav-bar-aria-label=\"navigation links\">\n" +
    "            <md-nav-item ui-sref=\"user.reussites\" class=\"reussites_session\" flex=\"45\" md-nav-click=\"goto('page1')\" name=\"page1\">\n" +
    ...
    "        </md-nav-bar>\n" +
    "    </md-content>\n" +
    ">>>>>>> Scrollbar removed from menu, footer margin-top 100px, badge margin-top 50px, Rechercher bottom 80% -->\n" +
    "</nav>\n"
  );
