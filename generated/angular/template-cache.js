angular.module("app").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("user/badger.html",
    ...
    "          <div class=\"demand\"><span class=\"user_name\">{{ user.firstname }} {{ user.lastname }}</span><br/><span class=\"name_badge\"> a demandé le badge <br/>\" {{ demandBadge.badge.name }} \"</span></div>\n" +
    "      </md-card-header>\n" +
    "      <img class=\"badge\" src=\"{{demandBadge.badge.url}}\"></img>\n" +
  ...
  $templateCache.put("user/home.html",
    ...
    "        <p><img ng-repeat=\"badge in badges | limitTo:10\" ng-click=\"showModal(badge)\" ng-model=\"newDemand\" type=\"submit\" class=\"career\" src=\"{{badge.url}}\">\n" +
    "            <md-button type=\"submit\" ng-click=\"showBadges()\" class=\"md-raised md-warn button_more\">Voir plus</md-button>\n" +
    "        </p>\n" +
    "    </md-card>\n" +
    "</div>\n" +
    "\n" +
  ...
  $templateCache.put("user/mes_reussites.html",
    ...
    "                                        <img ng-src=\"{{post.mood}}\" class=\"smiley_sunglasses\" alt=\"smiley\" />\n" +
    "                                    </div>\n" +
    "                                    <hr>\n" +
    "                                    <div class=\"post\">{{ post.content }}</div>\n" +
    "                                    <hr>\n" +
    "                                    <div class=\"smileys_delete\">\n" +
    "                                        <img ng-src=\"img/smileys/grinning.png\" class=\"compteur_smiley\" alt=\"smiley\" />\n" +
    "                                        <img ng-src=\"img/smileys/wink.png\" class=\"compteur_smiley smileys_test\" alt=\"smiley\" />\n" +
    "                                    </div>\n" +
